...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Manager.collectionToString(Autor.class, (Collection<Autor>) Manager.listCollection(Autor.class)));

        // 6. Creem les biblioteques
        System.out.println("\n=== Creant biblioteques ===");
        Biblioteca bibCentre = Manager.addBiblioteca("Biblioteca Central", "Barcelona", "Carrer Central 123", "93123456", "central@biblio.cat");
        Biblioteca bibNord = Manager.addBiblioteca("Biblioteca Nord", "Barcelona", "Avinguda Nord 45", "93789012", "nord@biblio.cat");
